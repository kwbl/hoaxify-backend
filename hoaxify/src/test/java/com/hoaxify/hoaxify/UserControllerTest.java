...
public class UserControllerTest {
	...
	private static final String API_V1_0_USERS = "/api/1.0/users";
	@Autowired
	...
	@Test
	public void postUser_whenUserHasNullUsername_receiveMessageOfNullForUsername() {
		User user = new User();
		ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
	...
	@Test
	public void postUser_whenUserHasInvalidPassordPattern_receiveMessageOfPasswordPatternError() {
		User user = createValidUser();
		user.setPassword("alllowercase");
		ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
		Map<String, String> validationErrors = response.getBody().getValidationErrors();
	...
	public void postUser_whenUserIsValid_receiveSuccessMessage () {
		...
		ResponseEntity<GenericResponse> response = testRestTemplate.postForEntity(API_V1_0_USERS, user, GenericResponse.class);
